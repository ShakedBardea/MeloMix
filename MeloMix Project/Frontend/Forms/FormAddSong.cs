    ...
    public partial class FormAddSong : Form
    {
        ...
        private void comboGener_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (comboGener.SelectedItem.ToString() == "Pop")
            {
                ...
                dataGridViewSong.DataSource = ListeningManager.GetSpecificListenings<Backend.Model.Song>();
        ...
        ////// you have to select Gener and then select which of the song to delete///////
        ...
        /////// you have to select Gener and then select which of the song to update/////////
        private void buttonUpdate_Click(object sender, EventArgs e)
        {
            ...
            string language = textBoxLanguage.Text;
            if (gener == "" || gener == "None")
                MessageBox.Show("you need to select Gener and then choose from the data", "OK", MessageBoxButtons.OKCancel);
            else
            {
                if (gener == "Pop")
                {
